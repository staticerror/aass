...
from htmlutils import encodeToAscii
...
if __name__ == '__main__':
    ...
    result = app.questionSearch({'query':'cats', 'search_in':'best_answer', 'results' : '10' })
    for res in result:
        print "Question:" + res['Subject'].encode('utf8') + res['Content'].encode('utf8') + "Answer:" +res['ChosenAnswer'].encode('utf8')
        print "\n"
